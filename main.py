...
from modeling.model_selection import select_asm_hemt_model
...
def select_model(state: ModelingState):
    selection = select_asm_hemt_model(
        analysis_result=state["analysis_result"],
        llm_advice=state.get("llm_advice"),
    )
...
graph_builder.add_node("select_model", select_model)
...
graph_builder.add_edge("ask_model", "select_model")
graph_builder.add_edge("select_model", END)
